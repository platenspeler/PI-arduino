/*
 * quhwaChime library v1.2.0 (20140128) 
 * (c) Maarten Westenberg
 *
 * License: GPLv3. See license.txt
 */

#ifndef quhwaReceiver_h
...
typedef void (*quhwaReceiverCallBack)(quhwaCode);

/**
* See RemoteSwitch for introduction.
*
* quhwaReceiver decodes the signal received from a 433MHz-receiver, like the "KlikAanKlikUit"-system
...
* A call to the callback must be finished before quhwaReceiver will call the callback function again, thus
* there is no re-entrant problem.
*
* When sending your own code using quhwaSwich, disable() the receiver first.
*
...
class quhwaReceiver {
	public:
		...
		* @param callback Pointer to a callback function, with signature void (*func)(quhwaCode)
		*/
		static void init(int8_t interrupt, byte minRepeats, quhwaReceiverCallBack callback);
	...
	private:
		...
		static quhwaReceiverCallBack _callback;
